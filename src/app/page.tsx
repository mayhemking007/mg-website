  ...
  return <main className="site-shell">
    ...
    <section id="home" className="hero-section scroll-mt-20 border-b border-white/10">
      <div className="hero-inner mx-auto grid max-w-7xl items-center gap-10 px-5 sm:px-8">
        <div className="hero-copy" data-reveal><p className="eyebrow">THE CONTROL LAYER AI APPLICATIONS</p><h1 className="font-semibold tracking-[-0.035em] text-white"><span className="hero-heading-line">View and control</span><span className="hero-heading-line"> what your AI</span><span className="hero-heading-line"> remembers.</span></h1><p className="hero-summary text-pretty">Inspect prompts, manage persistent memory, and govern the context your AI applications use across conversations and sessions.</p><div className="hero-actions"><Link className="btn-primary" href="/docs/quick-start">Get started <ArrowRight className="h-4 w-4" /></Link><a className="btn-secondary hero-github" href={githubUrl} target="_blank" rel="noreferrer"><GitBranch className="h-4 w-4" />GitHub</a></div><div className="hero-install"><InstallCommand /></div><ul className="hero-capabilities" aria-label="Key capabilities">{capabilities.map((item) => <li key={item}>{item}</li>)}</ul></div>
        <div className="hero-visual-wrap max-[499px]:hidden" data-reveal data-reveal-delay="1"><MemoryLifecycleVisual /></div>
      </div>
    </section>
    <HowItWorksSection />
    <DifferenceSection />
