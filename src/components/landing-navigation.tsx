...
import { ArrowRight, Menu, MemoryStick, X } from "lucide-react";
  ...
  return (
    <header className="landing-header">
      <div className="landing-nav-shell">
        <Link href="/" className="landing-brand" aria-label="MemoGrafter home">
          <span className="landing-brand-mark"><MemoryStick className="h-4 w-4" /></span>
          <span>MemoGrafter</span>
        </Link>
