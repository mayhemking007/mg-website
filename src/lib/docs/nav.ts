...
export const docsNavGroups: DocNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/guides/long-running-agents", label: "Long-running Agents", icon: "timer" },
      { href: "/docs/guides/knowledge-extraction", label: "Knowledge Extraction", icon: "scan-text" },
      ...
      { href: "/docs/guides/memory-review", label: "Memory Review", icon: "search-check" },
      { href: "/docs/guides/pruning", label: "Pruning", icon: "scissors" },
      { href: "/docs/guides/forget-memory", label: "Forget Memory", icon: "trash" },
